...
//class for requesting event deletion(accessed by staff/students)
class RequestDeletion
{
      public RequestDeletion(JFrame parent)//create constructor      
      {	
      	SpringLayout layout = new SpringLayout();
      	...
      	//create object of JButton
      	JButton b = new JButton("Select Date");
      	JButton request = new JButton("Request Deletion");
      	request.setBackground(Color.RED);
      	request.setOpaque(true);
      	...
      	//create object of JFrame and declare it final
          final JFrame f = new JFrame("Request Deletion");
      	f.getContentPane().add(p);
      	f.pack();
      	f.setSize(600, 300);
      	f.setVisible(true);
          ...
          public void actionPerformed(ActionEvent arg0) {
              ...
              //Displaying message and clearing text fields
              JOptionPane.showMessageDialog(f.getComponent(0), "Your requested event deletion has been sent to the principal for further review.");
              text.setText("");
              event.setText("");
              room.setText("");
              length.setText("");
              ...
              //calling method to add event to RequestedDeletions.txt
