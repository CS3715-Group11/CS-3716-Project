...
class Request 
{
        ...
        {	
        	...
        	final JFrame f = new JFrame("Request Event");
...
class AddDelete 
{
        public static void main(String[] args) // main method
        {
        	...
        	*/
        	...
        	layout.putConstraint(SpringLayout.WEST,timeLabel , 10, SpringLayout.WEST, p);
        	layout.putConstraint(SpringLayout.NORTH, timeLabel, 125, SpringLayout.NORTH, p);
        	layout.putConstraint(SpringLayout.NORTH, time, 125, SpringLayout.NORTH, p);
        	layout.putConstraint(SpringLayout.WEST, time, 84, SpringLayout.EAST, timeLabel);
            
        	layout.putConstraint(SpringLayout.WEST,create , 171, SpringLayout.WEST, p);
        	layout.putConstraint(SpringLayout.NORTH, create, 150, SpringLayout.NORTH, p);
        	layout.putConstraint(SpringLayout.NORTH, remove, 150, SpringLayout.NORTH, p);
        	layout.putConstraint(SpringLayout.WEST, remove,20, SpringLayout.EAST, create);
        	
        	
        	//create object of JFrame and declare it final
        	final JFrame f = new JFrame("Create/Remove Event");
        	f.getContentPane().add(p);
        	f.pack();
        	f.setSize(600, 300);
        	f.setVisible(true);
            ...
            //action listener for creating event
            create.addActionListener(new ActionListener() {
            	
            	/*setting variables values and creating new event 
                ...
                event=new Event(name, room, date, length); */

            public void actionPerformed(ActionEvent arg0) {
                JOptionPane.showMessageDialog(f.getComponent(0), "The event has been added to the schedule.");

            }
        });
            //action listener for removing event
             remove.addActionListener(new ActionListener() {

            public void actionPerformed(ActionEvent arg1) {
            	
            	//setting variables values and deleting specified event
            	
                JOptionPane.showMessageDialog(f.getComponent(0), "The event has been deleted from the schedule.");
